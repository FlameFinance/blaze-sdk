...
var Pairv2 = /*#__PURE__*/function () {
  ...
  Pairv2.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHEv = PAIR_ADDRESS_CACHEv2) === null || _PAIR_ADDRESS_CACHEv === void 0 ? void 0 : (_PAIR_ADDRESS_CACHEv$ = _PAIR_ADDRESS_CACHEv[tokens[0].address]) === null || _PAIR_ADDRESS_CACHEv$ === void 0 ? void 0 : _PAIR_ADDRESS_CACHEv$[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHEv2 = _extends({}, PAIR_ADDRESS_CACHEv2, (_extends5 = {}, _extends5[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHEv2 = PAIR_ADDRESS_CACHEv2) === null || _PAIR_ADDRESS_CACHEv2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHEv2[tokens[0].address], (_extends4 = {}, _extends4[tokens[1].address] = getCreate2Address(FACTORY_ADDRESSv2, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASHv2), _extends4)), _extends5));
    }
...
export { ChainId, Currency, CurrencyAmount, ETHER, FACTORY_ADDRESS, FACTORY_ADDRESSv2, Fetcher, Fraction, INIT_CODE_HASH, INIT_CODE_HASHv2, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Pairv2, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
